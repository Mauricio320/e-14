...
export const actaE14Schema = z.object({
  ...
  votos: z.array(votoCandidatoSchema).min(1, "Debe ingresar al menos un voto"),
  votosPorLista: z
    .array(votoListaSchema)
...
export const cambiarPasswordSchema = z
  .object({
    passwordActual: z.string().min(6, "La contraseña actual es requerida"),
    passwordNueva: z
      .string()
      .min(6, "La nueva contraseña debe tener al menos 6 caracteres"),
    confirmarPassword: z.string().min(6, "Confirme la nueva contraseña"),
  })
...
export const puestoVotacionSchema = z.object({
  ...
  nombre: z
    ...
    .min(3, "Nombre mínimo 3 caracteres")
    .max(200, "Nombre máximo 200 caracteres"),
  direccion: z.string().max(500, "Dirección máximo 500 caracteres").optional(),
