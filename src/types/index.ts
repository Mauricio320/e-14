...
export type PuestoVotacion =
  Database["public"]["Tables"]["puestos_votacion"]["Row"];
...
export type VotoCandidato =
  Database["public"]["Tables"]["votos_candidato"]["Row"];
...
export type AuditoriaCambio =
  Database["public"]["Tables"]["auditoria_cambios"]["Row"];
